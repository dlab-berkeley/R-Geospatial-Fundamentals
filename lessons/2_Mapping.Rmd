...
**T**ransformations help with ... C**lassification schemes** can improve the way data values are associated with colors.
...
Somethings that were emphasized in today's workshop, we focused on how
...
-   Understanding your data and knowing what aspects you want to emphasize enable you to utilize different color palettes and transformations to emphasize key aspects of the geographic distribution of the data.
