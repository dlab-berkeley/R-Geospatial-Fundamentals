...
bart_lines$len_m <- st_length(bart_lines)
...
bart_lines$len_mi_wgs84 <- units::set_units(st_length(st_transform(bart_lines,4326)), mi)

bart_lines$len_km_wgs84 <- units::set_units(st_length(st_transform(bart_lines,4326)), km)

bart_lines$len_m_wgs84 <- units::set_units(st_length(st_transform(bart_lines,4326)), m)
