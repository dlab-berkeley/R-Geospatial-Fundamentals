...
#plotting the BART lines 200m buffer and all schools within Alameda
...
the schools that are in within the BART line buffer polygons.
...
-   You can use `st_distance` and its companion function
    ...
    A and the nearest in B e.g. a middle school and the nearest high
    school.
...
-   Measurement queries involve calculating distances, areas, and other
    geometric properties within spatial datasets, such as the area of a
    boundary (county)
-   Spatial queries allow you to analyze how sets of geometries relate
    to each other in space. We looked at this, for instance, through
    using **`st_distance`** to find distances between schools and
    transportation lines.
-   Proximity analysis allows us to find nearby features within a
    certain distance, like identifying schools within a certain distance
    of transportation lines using buffers\\
