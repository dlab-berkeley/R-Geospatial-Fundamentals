...
1.  Read in the file `california_counties/california_counties.shp` (hint: follow the same filepath format as for the schools_sf object)
...
st_write(alameda_schools_sf,                            # Object
         "../data/alameda_schools/alameda_schools.shp", # Filepath
...
# Save to geopackage
st_write(alameda_schools_sf,                             # Object
         "../data/alameda_schools/alameda_schools.gpkg", # Filepath
         #delete_dsn = TRUE                              # Replace existing version of this file (if applicable)
         )                             
```
