...
Unzipo the folder downloaded from our last lesson and transfer the data contained within, into the 'Rasters' subfolder. It's found in the following R-Geospatial-Fundamentals \> data \> Rasters. Make sure to transfer all the files.

Let's explore the NLCD data:
...
#data source: https://www.mrlc.gov/data/nlcd-2011-land-cover-conus
```
