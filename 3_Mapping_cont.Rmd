...
3.  create a combined variable named `combined_clasi_plots` that shows the 4 plots, with. columns
...
In the next segment of the workshop, we will focus on spatial analyses ...
